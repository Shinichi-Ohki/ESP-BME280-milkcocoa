...
#define MILKCOCOA_APP_ID      "-- Your APP ID --"
...
void loop() {
  ...
  elem.setValue("Light", light_act);

  milkcocoa.push(MILKCOCOA_DATASTORE, &elem);
  //  delay(300UL * 1000UL);

  // Deepsleep設定 IO16とRESETをつなぐこと
  Serial.println("DEEP SLEEP START!!");
  //1:μ秒での復帰までのタイマー時間設定  2:復帰するきっかけの設定（モード設定）
  ESP.deepSleep(5UL * 60UL * 1000UL * 1000UL , WAKE_RF_DEFAULT);
